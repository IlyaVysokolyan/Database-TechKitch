...
@Component
public class RamSpecification implements SpecificationMethods<Ram> {

    public Specification<Ram> build(ParamsDto params) {
    ...
    public Specification<Ram> withBrand(String brandCont) {
    ...
    //Фильтр по модели
    public Specification<Ram> withModel(String modelCont) {
    ...
    public Specification<Ram> withPriceGt(Double priceGt) {
    ...
    public Specification<Ram> withPriceLt(Double priceLt) {
