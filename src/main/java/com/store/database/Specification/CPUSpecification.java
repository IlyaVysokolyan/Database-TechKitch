...
@Component
public class CPUSpecification implements SpecificationMethods<Processor> {
    public Specification<Processor> build(ParamsDto params) {
    ...
    public Specification<Processor> withBrand(String brandCont) {
    ...
    //Фильтр по модели
    public Specification<Processor> withModel(String modelCont) {
    ...
    public Specification<Processor> withPriceGt(Double priceGt) {
    ...
    public Specification<Processor> withPriceLt(Double priceLt) {
